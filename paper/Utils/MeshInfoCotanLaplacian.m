function mesh = MeshInfoCotanLaplacian(X, T, numEigs)
...
try
    ...
    %[mesh.laplaceBasis, mesh.eigenvalues] = eigs(mesh.cotLaplacian, numEigs, 1e-5);
    %[mesh.laplaceBasis, mesh.eigenvalues] = eigs(mesh.cotLaplacian, numEigs);
